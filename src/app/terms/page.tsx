            ...
            <div className="prose prose-lg max-w-none space-y-8">
                ...
                <div className="space-y-4">
                  <div>
                    ...
                    <p className="text-muted-foreground">
                      When you purchase a design from Atelier Designs, you receive a commercial license that allows you to:
                    </p>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed mb-4">
                  All products sold on Atelier Designs are digital design files. Upon purchase, you will receive:
                </p>
              ...
              <div>
                ...
                <p className="text-muted-foreground leading-relaxed">
                  All designs, content, and materials on this website are the property of Atelier Designs and are protected by 
